...
public class DemoQA_BrowserWindowSteps extends UtilityClass {
    ...
    public void userNavigatesToDemoQALinksPage() {
        ...
        // Initialise all page objects once; each uses the same shared driver
    ...
    public void userClicksOnMenuItem(String menuItem) {
        switch (menuItem) {
            ...
            case "Alerts":
                ...
                assertTrue("Expected URL to contain 'alerts'",
            ...
            case "Frames":
                ...
                assertTrue("Expected URL to contain 'frames'",
                        driver.getCurrentUrl().contains("frames"));
            ...
            case "Browser Windows":
                ...
                assertTrue("Expected URL to contain 'browser-windows'",
    ...
    public void theAlertShouldBeAcceptedSuccessfully() {
        // No result text for a simple alert – verify the driver is back on the page
    ...
    public void userClicksTheButton(String buttonLabel) {
        ...
        // Wait until a new tab handle appears – timeout read from config, no hardcoding
        ...
        // Isolate the new handle by removing the ones that existed before the click
    ...
    public void originalTabShouldDisplayBrowserWindowsPage() {
        ...
        assertTrue(
            "Expected original tab URL to contain 'browser-windows' but was: " + currentUrl,
